...
public interface Proj04Dictionary {
	...
	// - String is null
	void insert(int key, String data) throws IllegalArgumentException;
	...
	void delete(int key) throws IllegalArgumentException;
	...
	int getSuccessor(int key) throws IllegalArgumentException;
}
